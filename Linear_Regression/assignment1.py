...
def LR_evaluation(data,nfolds,learning_rate, numepochs):
    '''
    Contract : This function takes in dataset, the number of folds (splitting value), the learning rate
                and number of epochs as input
    Outcome : The functions results :
...
if __name__ == '__main__':
    ...
    # 1. Approach to removing NaN but not filtering them out
    ...
    numepochs = np.arange(1000,10000, 9000)
    model_score_lst=[]
    learning_error =[]
    final_predict_result=[]
    ...
    print "Note : Model learning and Prediction is done on Un-Normalized Dataset"
