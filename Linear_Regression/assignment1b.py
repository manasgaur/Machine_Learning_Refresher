...
Linear regression model over 2 variables (KnowlTrans and KnowlTransSq)
-- The dataset was not normalized
-- Nan values are identified and converted to zero. These observations were not removed
...
if __name__ == '__main__':
    ...
    print "Note : Model learning and Prediction is done on Un-Normalized Dataset (KnowlTrans and KnowlTransSq)"
