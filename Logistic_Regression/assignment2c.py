...
def sgd(traindata,l_rate, epochs):
    ...
    for epoch in range(epochs):
        ...
        for row in traindata:
            ...
            error = row[-1]-yhat
            sum_error += error**2 + lbda*(np.linalg.norm(np.asarray(coefs)))
...
if __name__ == '__main__':
    ...
    #working_frame['Gender'] = data['Gender'].copy(deep=True)
    ...
    #working_frame = working_frame[np.isfinite(working_frame['Gender'])]
